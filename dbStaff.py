staffDatabase = 'CREATE DATABASE staff' 
...
staffAlterations = [
'''
ALTER TABLE staffParticipant 
ADD FOREIGN KEY(client)
REFERENCES staffClient(client_id)
ON DELETE SET NULL;
''',
'''
ALTER TABLE staffCourse
ADD FOREIGN KEY(teacher)
REFERENCES staffEmployees(employee_id)
ON DELETE SET NULL;
''',
...
'''
CREATE TABLE staff_TakesCourse (
participant_id INT,
course_id INT,
PRIMARY KEY(participant_id, course_id),
FOREIGN KEY(participant_id) REFERENCES staffParticipant(participant_id) ON DELETE CASCADE,
FOREIGN KEY(course_id) REFERENCES staffCourse(course_id) ON DELETE CASCADE);
'''
]

staffPopulate = [
'''
INSERT INTO staffEmployees VALUES
...
''',
'''
INSERT INTO staffClient VALUES
...
''',
'''
INSERT INTO staffParticipant VALUES
...
''',
'''
INSERT INTO staffCourse VALUES
...
''',
'''
INSERT INTO staff_takesCourse VALUES
(101, 15),
(101, 17),
(102, 17),
(103, 18),
